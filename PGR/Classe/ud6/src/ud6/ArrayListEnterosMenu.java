...
public class ArrayListEnterosMenu {
	...
	public static void anadirString(Scanner sc, ArrayList<Integer> arr) {
		inr entrada;
	...
	public static int buscarString(Scanner sc, ArrayList<Integer> arr) {
		String entrada;
		System.out.println("un String ");
		entrada= sc.next();
	...
	public static void borrarString(Scanner sc, ArrayList<Integer> arr) {
		String entrada;
		boolean del;
		System.out.println("un String ");
		entrada= sc.next();
	...
	public static void listarArray(Scanner sc, ArrayList<Integer> arr) {
